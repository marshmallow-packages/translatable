...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createBlock)(_component_PanelItem, {
    ...
    value: (0,vue__WEBPACK_IMPORTED_MODULE_0__.withCtx)(function () {
      return [((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(true), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.renderList)($props.field.languages, function (language) {
        return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("span", {
          key: language.language
        }, [$props.field.toggler_clickable ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("a", {
          key: 0,
          href: language.toggle_path,
          title: language.name,
          "class": (0,vue__WEBPACK_IMPORTED_MODULE_0__.normalizeClass)(["mr-3 language-toggler", {
            selected: language.currently_selected
          }])
        }, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("img", {
          src: language.icon,
          "class": "rounded-full"
        }, null, 8 /* PROPS */, _hoisted_2)], 10 /* CLASS, PROPS */, _hoisted_1)) : ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("span", {
          key: 1,
          "class": (0,vue__WEBPACK_IMPORTED_MODULE_0__.normalizeClass)(["mr-3 language-toggler disabled", {
            selected: language.currently_selected
          }]),
          title: language.name
        }, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("img", {
...
var _hoisted_1 = ["data-translating", "data-source", "data-target"];
  ...
  return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createBlock)(_component_DefaultField, {
    ...
    field: (0,vue__WEBPACK_IMPORTED_MODULE_0__.withCtx)(function () {
      return [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("div", {
        ...
        "data-translating": $props.field.translating,
        "data-source": $props.field.source,
        "data-target": $props.field.target
      }, [((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(true), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)(vue__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,vue__WEBPACK_IMPORTED_MODULE_0__.renderList)($props.field.languages, function (language) {
        return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("span", {
          key: language.language
        }, [$props.field.toggler_clickable ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("a", {
          key: 0,
          ...
          src: language.icon,
          "class": "rounded-full"
        }, null, 8 /* PROPS */, _hoisted_3)], 10 /* CLASS, PROPS */, _hoisted_2)) : ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("span", {
          key: 1,
          "class": (0,vue__WEBPACK_IMPORTED_MODULE_0__.normalizeClass)(["mr-3 language-toggler disabled", {
            selected: language.currently_selected
          }]),
      ...
      }), 128 /* KEYED_FRAGMENT */))], 8 /* PROPS */, _hoisted_1), $props.field.toggler_notification ? ((0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementBlock)("p", _hoisted_6, [(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("span", {
        innerHTML: $props.field.toggler_notification
...
Nova.booting(function (Vue, router, store) {
  Vue.component("index-language-toggle-field", (__webpack_require__(/*! ./components/IndexField */ "./resources/js/components/IndexField.vue")["default"]));
  Vue.component("detail-language-toggle-field", (__webpack_require__(/*! ./components/DetailField */ "./resources/js/components/DetailField.vue")["default"]));
  Vue.component("form-language-toggle-field", (__webpack_require__(/*! ./components/FormField */ "./resources/js/components/FormField.vue")["default"]));
  var AutoTranslator = __webpack_require__(/*! ./mixins/auto-translator */ "./resources/js/mixins/auto-translator.js");
  AutoTranslator.init(Nova);
});

/***/ }),

/***/ "./resources/js/mixins/auto-translator.js":
/*!************************************************!*\
  !*** ./resources/js/mixins/auto-translator.js ***!
  \************************************************/
/***/ ((module) => {
...
var AutoTranslator = {
    ...
    _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return self.apiRequest('settings', 'GET');
          case 2:
            settings = _context.sent;
            _this.buttonText = settings.button_text;
            if (settings.active) {
  ...
  initAutoTranslator: function initAutoTranslator(Nova) {
    var self = this;
    Nova.$on('resource-loaded', function (data) {
      if (data.mode == 'update') {
        setTimeout(function () {
          var translator = document.getElementById('mm-translation-language-toggle');
          if (!translator) {
            return;
          }
          var translating = translator.getAttribute('data-translating');
          var source = translator.getAttribute('data-source');
          var target = translator.getAttribute('data-target');
          if (translating == false || translating == 'false' || !source || !target) {
            return;
          }
          _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
            var fields, _i, _Object$entries, _Object$entries$_i, field_name, field_type;
            return _regeneratorRuntime().wrap(function _callee2$(_context2) {
              while (1) switch (_context2.prev = _context2.next) {
                case 0:
                  _context2.next = 2;
                  return self.apiRequest('fields', 'POST', {
  ...
  getTextButton: function getTextButton(input, source, target) {
    var _this2 = this;
    return this.getDefaultButton( /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {
      return _regeneratorRuntime().wrap(function _callee3$(_context3) {
        while (1) switch (_context3.prev = _context3.next) {
          case 0:
            _context3.next = 2;
            return _this2.runTranslator(source, target, input.value);
          case 2:
  ...
  getTinyMceButton: function getTinyMceButton(field_name, source, target) {
    var _this3 = this;
    return this.getDefaultButton( /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4() {
      var tiny;
      return _regeneratorRuntime().wrap(function _callee4$(_context4) {
        while (1) switch (_context4.prev = _context4.next) {
          case 0:
            tiny = tinymce.get("tiny_".concat(field_name));
            _context4.next = 3;
            return _this3.runTranslator(source, target, tiny.getContent());
          case 3:
  ...
  runTranslator: function () {
    var _runTranslator = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5(source, target, text) {
      var response;
      return _regeneratorRuntime().wrap(function _callee5$(_context5) {
        while (1) switch (_context5.prev = _context5.next) {
          case 0:
            _context5.next = 2;
            return this.apiRequest('translate', 'POST', {
              source: source,
              target: target,
              text: text
            });
    ...
    function runTranslator(_x, _x2, _x3) {
      return _runTranslator.apply(this, arguments);
    }
    return runTranslator;
  }(),
  apiRequest: function () {
    var _apiRequest = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee6(path, mehod, body) {
      var rawResponse;
      return _regeneratorRuntime().wrap(function _callee6$(_context6) {
        while (1) switch (_context6.prev = _context6.next) {
          case 0:
            _context6.next = 2;
            return fetch("/nova-vendor/auto-translator/".concat(path), {
              method: mehod,
              headers: {
    ...
    function apiRequest(_x4, _x5, _x6) {
...
/* harmony import */ var _Users_stef_Sites_Marshmallow_Packages_nova_packages_io_nova_components_translatable_node_modules_vue_loader_dist_exportHelper_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./node_modules/vue-loader/dist/exportHelper.js */ "./node_modules/vue-loader/dist/exportHelper.js");
...
/* harmony import */ var _Users_stef_Sites_Marshmallow_Packages_nova_packages_io_nova_components_translatable_node_modules_vue_loader_dist_exportHelper_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./node_modules/vue-loader/dist/exportHelper.js */ "./node_modules/vue-loader/dist/exportHelper.js");




;
const __exports__ = /*#__PURE__*/(0,_Users_stef_Sites_Marshmallow_Packages_nova_packages_io_nova_components_translatable_node_modules_vue_loader_dist_exportHelper_js__WEBPACK_IMPORTED_MODULE_2__["default"])(_IndexField_vue_vue_type_script_lang_js__WEBPACK_IMPORTED_MODULE_1__["default"], [['render',_IndexField_vue_vue_type_template_id_9e63f81a__WEBPACK_IMPORTED_MODULE_0__.render],['__file',"resources/js/components/IndexField.vue"]])
/* hot reload */
if (false) {}
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkmarshmallow_nova_translatable"] = self["webpackChunkmarshmallow_nova_translatable"] || [];
