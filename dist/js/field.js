...
Nova.booting(function (Vue, router, store) {
  Vue.component('index-language-toggle-field', __webpack_require__(3));
  Vue.component('detail-language-toggle-field', __webpack_require__(6));
  Vue.component('form-language-toggle-field', __webpack_require__(9));
});
...
var render = function() {
  ...
  return _c("panel-item", { attrs: { field: _vm.field } }, [
    _c(
      ...
      _vm._l(_vm.field.languages, function(language) {
        return _c("span", { key: language.language }, [
          _vm.field.toggler_clickable
            ? _c(
                "a",
                {
                  staticClass: "mr-3 language-toggler",
                  class: { selected: language.currently_selected },
                  attrs: { href: language.toggle_path, title: language.name }
                },
                [
                  _c("img", {
                    staticClass: "rounded-full",
                    attrs: { src: language.icon }
                  })
                ]
              )
            : _c(
                "span",
                {
                  staticClass: "mr-3 language-toggler disabled",
                  class: { selected: language.currently_selected },
                  attrs: { title: language.name }
                },
                [
                  _c("img", {
                    staticClass: "rounded-full",
  ...
  return _c(
    ...
    [
      _c("template", { slot: "field" }, [
        _c(
          "div",
          { staticClass: "languages-overview" },
          _vm._l(_vm.field.languages, function(language) {
            return _c("span", { key: language.language }, [
              _vm.field.toggler_clickable
                ? _c(
        ...
        _vm._v(" "),
        _vm.field.toggler_notification
          ? _c("p", { staticClass: "mt-4" }, [
              _c("span", {
                domProps: { innerHTML: _vm._s(_vm.field.toggler_notification) }
              })
            ])
          : _vm._e()
      ])
...
var update = __webpack_require__(20)("fb94945a", content, false, {});
